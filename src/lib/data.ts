...
// make sure that the nomber show the index not the month
export const calendarEvents = [
...

  {
    ...
    end: new Date(2025, 2, 7, 15, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 2, 7, 17, 0),
    end: new Date(2025, 2, 6, 17, 45),
  },
  {
    title: "English",
    allDay: false,
  ...
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 2, 9, 9, 0),
    end: new Date(2025, 2, 9, 9, 45),
  },

  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 2, 9, 11, 0),
    end: new Date(2025, 2, 9, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 2, 9, 16, 0),
    end: new Date(2025, 2, 9, 16, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 2, 9, 15, 0),
    end: new Date(2025, 2, 9, 15, 45),
  },
];